...
public class A_Arithmetic {
	...
	public void presentToStudent() {
		...
		System.out.println("남 은 사 탕 개 수???");
		System.out.println("정답 : " + mod + "개");
		
		System.out.println("학생 한 명당 받을 수 있는 사탕의 개수 : " + (candies / students));
		System.out.println("남은 사탕 개수 : " + (candies % students));
