...
public class B_KeyboardInput {
	...
	public void inputTest() {
		...
		System.out.println("🍓. KH정보교육원에서 만든 딸기라떼");
		System.out.println("🍈. 케로케로케로피 멜론라떼");
		System.out.println("🥤. 요거 젤리 소다 플랫치노");
		System.out.println("=========================");
		...
		//              개행문자 이전까지 전체를 다 읽어옴
		// nextLine() : 입력버터에서 개행문자 이전까지의 모든 값을 가져온 후
		//              입력버퍼에서 존재하는 "개행문자"를 날려줌
