...
public class A_Variable {
	...
	public void findSeasonMenu() {
		...
		System.out.println("-----------------");
		//System.out.println("딸기라떼를 25잔 주문하셨습니다.");
		...
		// 다음과 같이 출력하시오
		// ↓
		// 케로케로케로피 멜론라떼 30잔 주문하셨습니다.
		// (메뉴가격 * 개수)원 입니다.
		System.out.println("-----------------");
		System.out.println("케로케로케로피 멜론라떼 30잔 주문하셨습니다.");
	...
	public void declareVariable() {
		 ...
		 * int 형을 주로 쓰세용~~!
		 * long 형을 사용할 때는 대입할 숫자 뒤에 "L'을 붙임
		 * 
		 * 실수형
		 * 
		 * 실수형에는 2가지 자료형이 존재
		...
		// 출력문의 종류
		// System.out.print();
		//Systemm.out.println(); => 개행한다
		// System.out.prontln("isTrue라는 변수에 대입한 값 : " + isTrue + ", char형은 : " + gold);
