...
public class StringController {
	 ...
	 * String 클래스 사용방법
	 * 
	 * 1. new 연산자를 사용해서 String 클래스의 생성자를 호출하는 방법
	...
	public void method1() {
		...
		System.out.println(run); // 런클래스의 부모클래스인 오브젝트클래스의 투스트링 메소드의 참조자료형 주소값 호출
	...
	public void stringMethod() {
		...
		// 6. 문자열.replace(char old, char new) : Stirng
		...
		//String upperAnser = answer.toUpperCase();
