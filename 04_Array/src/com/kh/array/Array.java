...
public class Array {
	...
	public void method1() {
		...
		/*
		 * int num1 = 12; int num2 = 13; int num3 = 77; int num4 = 58; int num5 = 89;
		 * 
	...
	public void methodA() {
		 ...
		 * 바로 담을 수 있음 : (지역)변수 참조자료형 : boolean[], char[], byte[], int[] ... String =>
	...
	public void methodD() {
		...
		/*
		 * 연결이 끊긴 기존의 배열은 일정시간이 지나면 G.C가 알아서 삭제 해준다. : 자동 메모리 관리 (Managed)
		 * 
		 * 기존 배열 식별자에 할당만 새롭게 한다면 => 기존 참조하고 있던 연결이 끊기고 새로운 배열을 참조함
		 */
