...
public class Run {
	 ...
	 * 
	 * 추상적자료형(ADT) Abstract Data Type ==> Interface
	 * +
	 * 구현체 => Class
	 * +
	 * 알고리즘 => method
	 ...
	 * 
	 * -- 중립
	 * - 배열의 경우 기본적으로 하나의 타입의 자료형만 사용할 수 있음
	 * - 컬렉션의 경우 여러 타입의 데이터들을 관리할 수 있음 : 같은 타입의 데이터만 묶어서도 사용 가능
	 * 
	 ...
	 * 					-> ArrayList 
	 * 
	 * - Set 계열 : 다루고자 하는 값(Value)만 저장 / 저장 시 순서 유지 X, 중복값 허용X
	 * 					=> HashSet, TreeSet
	 * 					-> HashSet
	 * 
	...
	*/
	...
	// 기존 Object[]의 크기를 넘어서는 요소가 추라될 경우
	...
	System.out.println(plants);
	// 중간위치에 요소를 추가했을 때 기존의 요소들을 한 칸씩 밀어주는 작업이 내부적으로 구현되어있음
