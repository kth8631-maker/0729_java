...
public class Run {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < 3; i++) {
			...
			System.out.print("식당의 주력 메뉴를 입력해주세요 > ");
		 ...
		 * 
		 * System.out.print("식당의 주력 메뉴를 입력해주세요 > "); String mainMenu2 = sc.nextLine();
		 * 
		 ...
		 * 
		 * System.out.print("식당의 주력 메뉴를 입력해주세요 > "); String mainMenu3 = sc.nextLine();
		 * 
		...
		/*
		for(int i =0; i<3; i++) {
			if(searched.equals(r1.getAddress().??))
		}
		*/
