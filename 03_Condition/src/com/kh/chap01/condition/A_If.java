...
public class A_If {
	...
	public void lunchMenu() {
		...
		// 만약에 사용자가 입력한 문자열이 "맑은"과 일치하다면
		if(weather.equals("맑음")) {
			System.out.println("종로삼계탕에서 전복삼계탕 드세요~");
		}
	...
	public void method4() {
		...
		System.out.println("1. 아메리카노 4500원");
		System.out.println("2. 카페라떼 5000원" );
		...
		if(menuNo == 2) menuName = "카페라떼";
		if(!(menuNo == 1) && !(menuNo == 2)) menuName = "없는메뉴";
		
		// 5. xxxx 메뉴를 xxx잔 주문하셨습니다. 출력해주기 print()
		...
		if(answer == 'Y' || answer == 'y') {
			int price = 0;
			if(menuNo == 1) price = 4500;
			if(menuNo == 2) price = 5500;
