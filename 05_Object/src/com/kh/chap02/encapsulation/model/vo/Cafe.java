...
public class Cafe {
	 ...
	 * setter만들기 규칙
	 * 
	 * 1. setter메소드는 외부에서 접근이 가능해야 하기 떄문에 접근제한자 public을 이용
	 * 2. set필드명으로 식별자를 작성하며 낙타봉표기법(camelCase)을 지키도록 한다.
	 * 
	...
	/*
	 * 관례 위반 : 두개 이상의 필드값을 변경하는 메소드는 set이 붙으면 XXX
	...
	*/
	 ...
	 * 2. get필드명으로 짓되, 낭타봉표기법(camelCase)를 사용한다.
	...
	// getter() / setter()다만들었당 ! ==> 캡슐화가 끝남(문법적인 관례)
	/*
