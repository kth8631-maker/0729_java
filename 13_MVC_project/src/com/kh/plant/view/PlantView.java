...
public class PlantView {
	...
	private void createPlant() {
		...
		System.out.println();
		System.out.println("\n💚 식물추가서비스입니다.");
		System.out.println("식물명을 입력해주세요 > ");
	...
	private void readAll() {
		...
		List<Plant> plants = pc.readAll(); // Object형 배열이 필요해
	...
	private void deletePlant() {
		...
		int count = pc.deletePlant(name, type); // 0일지 1일지 100일지 모르니까 일단 변수로 담아줘 반환타입 인트니까 인트로
